...
— `studio/.claude/skills/`, thirty-eight skills — runs locally inside Claude on a
...
Those thirty-eight skills live in `studio/.claude/skills/` and are directory-scoped:
