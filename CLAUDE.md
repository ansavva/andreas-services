...
— `studio/.claude/skills/`, thirty-three skills — runs locally inside Claude on a
...
Those thirty-three skills live in `studio/.claude/skills/` and are directory-scoped:
