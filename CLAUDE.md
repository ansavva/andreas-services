...
— `studio/.claude/skills/`, twenty-seven skills — runs locally inside Claude on a
...
Those twenty-seven skills live in `studio/.claude/skills/` and are directory-scoped:
