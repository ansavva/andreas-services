# Codex Instructions – andreas-services Monorepo
...
5. Add TypeScript
6. Add a `AGENTS.md` inside the service directory with service-specific context
7. Document subdomain in the service README (e.g., `events.andreas.services`)

## Branch Conventions

Development branches follow the pattern `Codex/<feature-name>-<id>`.
