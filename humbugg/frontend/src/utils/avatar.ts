...
/**
 * Validates a chosen file against the same content-type and size limits the backend enforces.
 * Returns an error message to display, or null when the file is acceptable.
 */
...
/** Reads a file as a base64 data URL suitable for the upload endpoint. */
