...
public sealed class GroupServiceSecurityTests
{
    ...
    private sealed class Fixture
    {
        ...
        public Fixture(MembershipRecord? member, IReadOnlyList<string[]>? exclusions = null)
        {
            ...
            Subject = new GroupService(new FakeUser(), new FakeProfiles(), Groups, Members, new FakeWishes(), new MatchingService(), new PlanCatalog(new()), new FakeAuditTrail(), new FakeProductAnalytics(), new HumbuggSettings(
