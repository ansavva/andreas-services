...
Twenty-four skills live in `studio/.claude/skills/`, in two families. Route by what
the task **changes**, not by what it mentions:

| Changing… | Load |
|---|---|
| media, or a catalog record — an image, a clip, a character, a project, a run, a scene, a movie | a **`studio-media-*`** skill (twenty-three) |
