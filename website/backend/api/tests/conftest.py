...
from website_core.adapters import store  # noqa: E402
from website_core.common import config  # noqa: E402
...
def intake_table():
    ...
    with mock_dynamodb():
        store._dynamodb = None  # drop any cached resource from a prior test
