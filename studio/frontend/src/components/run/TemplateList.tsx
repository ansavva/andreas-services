 ...
 */
/**
 * The templates, as a list to pick from — the body of the bar's Template
 * dropdown. Loads on mount, so it is rendered only while the dropdown is open.
 */
export function TemplateList({ onPick, cast }: Props) {
