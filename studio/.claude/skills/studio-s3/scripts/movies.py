...
CLI
---
    uv run movies.py new <project> --slug <slug> --scene <ref> --scene <ref> …
    uv run movies.py list <project>
    uv run movies.py show <project>/latest
    uv run movies.py outputs <project>/latest --presign
"""
...
import scenes as SC  # noqa: E402  — for sceneref resolution, not for ffmpeg
from s3_common import BUCKET, client, die, list_keys  # noqa: E402
from video import probe, stitch  # noqa: E402  — the same joiner scenes use
