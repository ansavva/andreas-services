...
**Load one before doing anything else in `studio/`.** Twenty-one skills in **two
families** — twenty `studio-media-*` and one `studio-code-*`; route by what
...
| Pick an image engine | `studio-media-nano-banana-pro` · `studio-media-nano-banana-2` · `studio-media-gpt-image-2` · `studio-media-gpt-image-1-5` · `studio-media-seedream-5-pro` · `studio-media-krea-2-large` |
