...
def generate_page_image(page_id):
    ...
    try:
        ...
        from storybook_core.repositories.character_asset_repo import CharacterAssetRepo
...
def export_story_pdf(project_id):
    """Export story as PDF"""
    try:
        from storybook_core.services.pdf_export_service import PDFExportService
        from storybook_core.repositories.story_project_repo import StoryProjectRepo
        from storybook_core.clients.aws.s3 import S3Storage
