...
def core():
    return dynamodb.table(CORE_TABLE)
...
def ensure_local_tables_exist():
    """Create Scout's DynamoDB tables when running against local DynamoDB."""
    dynamodb.ensure_local_tables_exist(CORE_TABLE, SETTINGS_TABLE)
