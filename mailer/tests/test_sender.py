...
from mailer.core.errors import AttachmentBlockedError, RetryableError
from mailer.entrypoints.sender_lambda import _attachments
...
class FakeS3:
    ...
    def get_object_tagging(self, **_kwargs):
        if self.status is None:
            return {"TagSet": []}
        return {
            "TagSet": [{"Key": "GuardDutyMalwareScanStatus", "Value": self.status}]
        }
        ...
        "attachments": [
            {
                ...
                "object_key": "attachments/humbugg/hmb_123/att_123",
                "file_name": "guide.pdf",
