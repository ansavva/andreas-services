...
from mailer.errors import ConflictError
...
def service():
    return ServiceConfig(
        ...
        configuration_set="mailer-humbugg-product-production",
        send_queue_url="https://sqs.example/send",
    )


def message(subject="Invitation"):
    return MessageRequest.from_dict(
        {
            "schema_version": 1,
            "application_message_id": "hmb_123",
            "category": "invitation",
