...
BLOCKED_EXTENSIONS = {
    ...
    ".hta", ".inf", ".ins", ".isp", ".its", ".js", ".jse", ".ksh", ".lib",
    ".lnk", ".mad", ".maf", ".mag", ".mam", ".maq", ".mar", ".mas", ".mat",
    ".mau", ".mav", ".maw", ".mda", ".mdb", ".mde", ".mdt", ".mdw", ".mdz",
    ".msc", ".msh", ".msh1", ".msh2", ".mshxml", ".msi", ".msp", ".mst",
    ".ops", ".pcd", ".pif", ".plg", ".prf", ".prg", ".reg", ".scf", ".scr",
    ".sct", ".shb", ".shs", ".sys", ".ps1", ".ps1xml", ".ps2", ".ps2xml",
    ".psc1", ".psc2", ".tmp", ".url", ".vb", ".vbe", ".vbs", ".vps", ".vsmacros",
...
class AttachmentUploadRequest:
    ...
    def from_dict(cls, value: dict[str, Any]) -> AttachmentUploadRequest:
        ...
        message_id = _identifier(value.get("application_message_id"), "application_message_id")
        ...
        if (
            ...
            raise ValidationError(f"size_bytes must be between 1 and {MAX_ATTACHMENT_BYTES}")
...
class AttachmentReference:
    ...
    def from_dict(
        ...
        if internal:
            allowed |= {"object_key", "file_name", "content_type", "size_bytes", "sha256"}
...
class MessageRequest:
    ...
    def from_dict(
        ...
        *,
        ...
        if not isinstance(attachments_value, list) or len(attachments_value) > MAX_ATTACHMENTS:
            raise ValidationError(f"attachments must contain at most {MAX_ATTACHMENTS} items")
        attachments = tuple(
            AttachmentReference.from_dict(item, internal=internal) for item in attachments_value
        )
